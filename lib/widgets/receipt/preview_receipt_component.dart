...
void main() {
  runApp(const ReceiptComponentPreviewApp());
}

class ReceiptComponentPreviewApp extends StatelessWidget {
  const ReceiptComponentPreviewApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: const ReceiptComponentPreviewPage(),
    );
  }
}

class ReceiptComponentPreviewPage extends StatelessWidget {
  const ReceiptComponentPreviewPage({super.key});
