...
class ReceiptComponent extends StatelessWidget {
  ...
  const ReceiptComponent({
    ...
    this.checkIconAssetPath = 'lib/assets/images/receipt/check.svg',
      ...
      builder: (context, constraints) {
        return Container(
          ...
          decoration: BoxDecoration(
            color: _kReceiptSurface,
            borderRadius: BorderRadius.circular(_kReceiptCardRadius),
            boxShadow: const [
              BoxShadow(
                color: _kReceiptShadowPrimary,
                offset: Offset(0, 4),
                blurRadius: 4,
              ),
              BoxShadow(
                color: _kReceiptShadowAmbient,
                offset: Offset(0, 24),
                blurRadius: 48,
                spreadRadius: -10,
              ),
  ...
  Widget _buildCheckIcon() {
    final assetPath = checkIconAssetPath;
    if (assetPath != null) {
      return SizedBox(
        width: 52,
        height: 52,
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        color: _kReceiptConfirmationGreen,
      ),
